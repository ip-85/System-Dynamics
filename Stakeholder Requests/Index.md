...
Функцыональнысть сервісу анкетування направлена на надання послуг з створення і проходження анкет, а також збору і обробки результатів опитувань. Результатом роботи сервісу є отримання клієнтом необхідних даних.
...
Управління онлайн сервісом з анкетування відбувається за допомогою автоматизованої системи, що складається з операторів, які взаємодіють з клієнтами нашого сервісу- респондентами та інтерв’юерами, а також оператора зворотного зв’язку, який взаємодіє із менеджерами з обслуговування клієнтів.   
...
##### 3.4 Процес створення та реалізації нового опитування
...
4.	Оператор взаємодії з інтерв’юерами обробляє і аналізує отримані дані, після чого надає інтерв’юеру звіт з результатами опитування.
