...
| Види обробки                                  | Діаграми, таблиці, списки                                                         | Підтримка методів графічного аналізу даних (кластерний аналіз); підтримку методів багатовимірного статистичного аналізу даних (факторний аналіз); ремонт вибірки шляхом зважування; побудова графіків і гістограм; побудова рівнянь лінійної регресії; побудова кореляційної матриці; |
| Взаємодія з респондентом                      | Можна залишити фідбек, отримати свої відповіді на пошту                           | Присутня пошта а також контактні телефони компанії Фахівці допоможуть написати запит на проведення дослідження, запропонують необхідні для проведення дослідження методи, створять інструментарій, розрахують вибірку, оцінять необхідний бюджет на проведення дослідження, проведуть аудит пропозицій і результатів досліджень. |
