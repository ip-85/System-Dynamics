...
Зручний сервіс для програмістів, де результати опитувань інтегруються в якесь інше програмне середовище: формат JSON підходить для роботи передачею файлів (особливо, якщо програмний код написаний мовою JavaScript). Сучасний і зручний дизайн сайту і самої програми. Велика кількість довідкової інформації, що дає змогу швидше розібратись в програмі, обмежена кількість варіацій аналізу даних. Підходить для великих компаній, але через значну вартість звичайному користувачу - ні. Сервіс розрахований на використання в бізнес цілях.
