...
| Види обробки                                  | Діаграми, таблиці, списки                                                         
| підтримку методів графічного аналізу даних (кластерний аналіз); підтримку методів багатовимірного статистичного аналізу даних (факторний аналіз); ремонт вибірки шляхом зважування;
 побудова графіків і гістограм; побудова рівнянь лінійної регресії; побудова кореляційної матриці; |
| Взаємодія з респондентом                      | Можна залишити фідбек, отримати свої відповіді на пошту                           | Присутня пошта а також контактні телефони компанії
Фахівці допоможуть написати запит на проведення дослідження, запропонують необхідні для проведення дослідження методи, створять інструментарій, розрахують вибірку, оцінять необхідний бюджет на проведення дослідження, проведуть аудит пропозицій і результатів досліджень. |
| Можливість розширення                         | Легко можна розширити існуючу форму, скопіювати та змінити її                     | У модулі є можливість управління введенням - автоматичне заповнення деяких ділянок анкети на основі раніше наведеній інформації | 
| Вартість володіння                            | 0$/5.40$/10.20$/25$ на місяць, в залежності від потреб інтеграції екосистеми гугл | безкоштовно, але є можливість найняти "ОСА" для проведення масштабного опитування і аналіз даних |
