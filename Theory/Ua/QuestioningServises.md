...
| Види обробки                                  | Діаграми, таблиці, списки | Підтримка методів графічного аналізу даних (кластерний аналіз); підтримку методів багатовимірного статистичного аналізу даних (факторний аналіз); ремонт вибірки шляхом зважування; побудова графіків і гістограм; побудова рівнянь лінійної регресії; побудова кореляційної матриці; | Функцією аналізу тексту для пошуку і класифікації відповідей в довільній формі і швидкого виявлення часто використовуваних слів і фраз; багатомовні опитування; перехресні таблиці; | |  Шкали, ранжування, вибір зображення, текстовий відповідь, зірки і всього 11 варіантів | 
| Взаємодія з респондентом                      | Можна залишити фідбек, отримати свої відповіді на пошту                           | Присутня пошта а також контактні телефони компанії Фахівці допоможуть написати запит на проведення дослідження, запропонують необхідні для проведення дослідження методи, створять інструментарій, розрахують вибірку, оцінять необхідний бюджет на проведення дослідження, проведуть аудит пропозицій і результатів досліджень. | Цілодобова підтримка користувачів по електронній пошті ,а також по телефону; Також надається персональній менеджер для роботи з клієнтами; | | Респондент може лише розповсюджити анкету через почту чи соц мережі |
...
| Вартість володіння                            | 0$/5.40$/10.20$/25$ на місяць, в залежності від потреб інтеграції екосистеми гугл | Безкоштовно, але є можливість найняти "ОСА" для проведення масштабного опитування і аналіз даних | | | 0$/16$/33$/66$ на місяць |
