...
| Можливість розширення                         | Легко можна розширити існуючу форму, скопіювати та змінити її                     | У модулі є можливість управління введенням - автоматичне заповнення деяких ділянок анкети на основі раніше наведеній інформації | Цілодобова підтримка користувачів по електронній пошті ,а також по телефону; Також надається персональній менеджер для роботи з клієнтами; | | В наявності велика кількість шаблонних форм, які можна змінювати під свої потреби. Легко можна розширити існуючу форму, скопіювати та змінити її. |
