...
* Формування пакетів результатів опитування, для передачі їх аналітикам;
...
Можливості:
* Декілька режимів перегляду, для зручного відображення результатів опитування;
* Вибірка інструментів для аналізу даних;
* Статистичні механізми для прогнозування відповідей;
* Можливість формування звітності для замовника;

#### 5.4 <a name = "Інтерфейс-адміністратора">Інтерфейс адміністратора</a>
...
* Можливості "відігравати роль" (діяти, мати доступ до можливостей) як інтерв’юера, так і респондента;
