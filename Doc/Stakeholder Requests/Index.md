...
* Модифікація набору функцій, доступних в режимі респондента
* Модифікація набору функцій, доступних в режимі інтерв’юера 
* Модифікація набору функцій, для взаємодії двох сторін

1. Можливості, доступны для режиму респондента   
Функціонії в режимі респондента являють собою набір форм і пунктів меню, що забезпечує:   
...
Функці в режимі інтерв’юера являють собою набір форм і пунктів меню, що забезпечує виконання наступних функцій:   
