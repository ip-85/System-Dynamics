...
Передумова - аналітик використовує відповідний акаунт, що надає особливі можливості для аналізу даних і взаємодії з користувачами.     
...
Це дозволяє цілісно проаналізувати створюване опитування, поетапно прослідкувати та "відловити" (виявити) недоліки проектування моделі опитування.
...
#### 6.1 <a name="Локалізація"> Локалізація</a>
  Сервіс з анкетування повинен підтримувати такі мови інтерфейсу, як: російська, українська та англійська.
  
#### 6.2 <a name="Мультиплатформеність"> Мультиплатформеність</a>
  Сервіс анкетування повинен бути адаптований для доступу як для звичайних комп’ютерів, так і для мобільних пристроїв, що мають підключення до мережі Інтернет.
